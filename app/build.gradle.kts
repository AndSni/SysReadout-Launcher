...
android {
    namespace = "com.asnidev.sysreadout"
    compileSdk = 36
...
dependencies {
    ...
    // Backdrop blur for the frosted menu entries (API 31+, scrim fallback below).
    implementation("dev.chrisbanes.haze:haze:1.1.1")

    // Optional shell-level access for the system monitor (processes, connections).
